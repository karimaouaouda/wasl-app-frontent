import { Switch, Text, View, Image, TouchableOpacity, ScrollView, RefreshControl } from "react-native";
...
export default function ActiveTab() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                console.log(`fetching data from ${process.env.EXPO_PUBLIC_API_URL}/orders`);
